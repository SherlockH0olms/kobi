        ...
        <div className="flex flex-col items-center justify-center py-12 space-y-4">
          ...
          <div className="text-center space-y-2">
            ...
            <p className="text-muted-foreground max-w-md">
              Your application has been sent to {selectedLoanIds.length} lender{selectedLoanIds.length !== 1 ? 's' : ''}. They will contact you shortly.
            </p>
          </div>
        </div>
          ...
          <div className="flex gap-3">
            ...
            <div className="text-sm text-muted-foreground">
              ...
              <ul className="list-disc list-inside space-y-1">
                ...
                <li>Compare offers and choose the best option for your business</li>
              </ul>
            </div>
          </div>
        </div>
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">
          You're about to apply to {selectedLoanIds.length} lender{selectedLoanIds.length !== 1 ? 's' : ''}. They'll review your information and contact you with their decisions.
        </p>
      </div>

      {/* Company info summary */}
      <div className="bg-muted/30 rounded-lg p-4 border border-border/50">
        <p className="text-xs text-muted-foreground mb-3 font-medium">APPLYING AS</p>
      ...
      {/* Selected loans */}
      <div>
        <p className="text-sm font-medium text-foreground mb-3">SELECTED LENDERS</p>
        <div className="space-y-2">
          {selectedLoans.map(loan => (
            ...
            >
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {loan.annualInterestRate}% APR • {loan.repaymentPeriodMonths} months
                </p>
              </div>
      ...
      <div className="space-y-3">
        <label className="flex items-start gap-3 cursor-pointer p-3 hover:bg-muted/50 rounded-lg transition-colors">
          ...
          <span className="text-sm text-muted-foreground">
            I agree that KÖBİ Kredit Platforması can share my information with selected lenders so they can contact me with offers. I understand that multiple hard inquiries may impact my credit temporarily.
          </span>
        </label>
      </div>
      ...
      >
        {isLoading ? 'Submitting Applications...' : 'Submit Applications to All Lenders'}
      </Button>
