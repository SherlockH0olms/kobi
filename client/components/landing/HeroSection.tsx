      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-20">
          ...
          <div className="space-y-8 animate-fade-in">
            <div className="space-y-4">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-lg leading-relaxed">
                AI Market Gap Finder sosial media və biznes fürsətlərini proqnozlaşdıran niş imkanları üzə çıxarır.
              </p>
            </div>
              ...
              <div className="relative bg-white rounded-2xl shadow-2xl p-8 border border-border transform hover:scale-105 transition-transform duration-300 -rotate-2 hover:rotate-0">
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    <h3 className="font-heading font-bold text-sm text-foreground">Market Gaps</h3>
                  ...
                  <div className="space-y-2">
                    {[1, 2, 3].map(i => (
                      ...
                      >
                        ...
                        <span className="text-xs text-success font-semibold">+{15 + i * 5}%</span>
                      </div>
                    ))}
                  </div>
        ...
        <div className="mt-20 grid grid-cols-1 sm:grid-cols-3 gap-8 bg-secondary/5 rounded-2xl p-8 sm:p-12 border border-border/50">
          <div className="text-center">
            <div className="text-4xl sm:text-5xl font-heading font-bold text-secondary mb-2">12,000+</div>
            <p className="text-sm text-muted-foreground">Small businesses analyzed</p>
          </div>
          <div className="text-center border-l border-r border-border/50">
            <div className="text-4xl sm:text-5xl font-heading font-bold text-secondary mb-2">8.2M AZN</div>
            <p className="text-sm text-muted-foreground">Loans matched</p>
          </div>
          <div className="text-center">
            <div className="text-4xl sm:text-5xl font-heading font-bold text-secondary mb-2">95%</div>
