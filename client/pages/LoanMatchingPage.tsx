...
export default function LoanMatchingPage() {
  ...
  if (maxRate) {
    filteredLoans = filteredLoans.filter(loan => loan.annualInterestRate <= maxRate);
  }
  ...
  if (sortBy === 'rate') {
    ...
    filteredLoans = [...filteredLoans].sort((a, b) => b.loanAmountMax - a.loanAmountMax);
  } else if (sortBy === 'period') {
    filteredLoans = [...filteredLoans].sort((a, b) => a.repaymentPeriodMonths - b.repaymentPeriodMonths);
  }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground max-w-2xl">
            We found {loans.length} lenders ready to work with your credit profile. Compare rates, terms, and features below.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-sm border border-border p-4 sm:p-6 mb-8">
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
              ...
              >
                <option value="rate">Sort by: Interest Rate (Low to High)</option>
                <option value="amount">Sort by: Loan Amount (High to Low)</option>
                <option value="period">Sort by: Repayment Period (Short to Long)</option>
              </select>
        ...
        {filteredLoans.length > 0 ? (
          ...
          <div className="bg-muted/30 rounded-lg p-8 text-center border border-border/50">
            <p className="text-muted-foreground mb-4">
              No loans match your current filters. Try adjusting your preferences.
            </p>
